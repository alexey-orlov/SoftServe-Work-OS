...
**Read `product-development/product/strategy/business-context/business-info.md` in full before any PRD, pricing, positioning, metric-definition, competitive, or strategy work.** The block above is the summary. That file is the source of truth for personas, value proposition, GTM motion, market sizing, and product principles.
...
| Designer | `design/`, `product/PRDs/` (rationale sections) | Design rationale, UX findings |
