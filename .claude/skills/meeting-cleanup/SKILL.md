...
Upload or paste all of today's meeting transcripts, and the skill will:
...
**Shortcut:** Just paste your transcripts and say `/meeting-cleanup` -- The skill will handle the rest.
...
|--------|---------------|--------------|-----------------|
| Business Info | `product-development/product/strategy/business-context/business-info.md` | company, product, team | Company context for interpreting discussions |
| Stakeholder Profiles | `product-development/product/strategy/business-context/stakeholders.md` | attendees' names | Communication preferences, roles, decision authority |
| Active PRDs | `product-development/product/PRDs/{area}/*.md` | features discussed | Link action items to active PRDs |
| Previous Meetings | `product-development/product/meetings/*.md`, `product-development/product/meetings/{type}/summaries/` | same meeting name, same attendees | Carry-over items, open questions from last time |
| Strategy | `product-development/product/strategy/*.md` | strategic pillars, OKRs | Align decisions to strategic context |
| Decisions | `product-development/product/decisions/*.md` | related decisions | Check for conflicts with past decisions |
...
5. **Strategic alignment is noted for each decision** -- tie decisions to strategic pillars from `product-development/product/strategy/` when relevant
...
When the PM uses `/meeting-cleanup`, the skill automatically:

### 1. Extract Action Items Intelligently
**Source:** All meeting transcripts provided
- **What What to look for:** Implicit and explicit action items, owners, deadlines
- **How the skill uses it:** Consolidate into single master list with owners
...
- **What What to look for:** Decisions that came out of meetings
- **How the skill uses it:** Flag for `/decision-doc` if significant
...
- **What What to look for:** Which system to create tickets in
- **How the skill uses it:** Auto-create tickets if MCP connected
...
- **What What to look for:** Same topic discussed in multiple meetings
- **How the skill uses it:** Note patterns and highlight for attention
...
- **What What to look for:** Related action items from earlier days
- **How the skill uses it:** Note dependencies and blockers across meetings
