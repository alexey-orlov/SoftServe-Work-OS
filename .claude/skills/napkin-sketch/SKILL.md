...
1. Provide what screen or feature you want to sketch
...
**Output:** Wireframe delivered inline, also saved to `product-development/design/prototypes/[feature]-napkin-sketch.md`
