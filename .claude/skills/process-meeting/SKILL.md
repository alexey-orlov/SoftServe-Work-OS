...
| **Competitor intel** | `competitive-research/competitors/{slug}/teardown.md` (first intel: scaffold the folder + stub, copy `processes/templates/competitor-teardown-template.md`) + refresh the affected `competitive-matrix.md` cells |
