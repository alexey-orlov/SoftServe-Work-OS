...
1. Provide what you want to prototype (feature name, PRD link, or description)
2. You'll be asked which tool: **v0.dev** (UI only), **Lovable** (full-stack), or **Bolt.new** (quick demo)
3. The skill checks your PRD, design system, and user research for context
4. The skill generates a copy-paste-ready prompt optimized for the tool
