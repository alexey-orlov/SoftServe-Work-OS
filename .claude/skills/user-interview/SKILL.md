...
Output: product-development/product/customers/research-synthesis/[date]-interview-insights.md
```
...
|--------|---------------|----------|
| product-development/product/customers/ | Previous interview syntheses, existing themes | High |
| product-development/product/PRDs/{area}/ | Active PRDs that this interview relates to | High |
| product-development/product/strategy/business-context/stakeholders.md | If interviewee is a known stakeholder/customer | Medium |
| product-development/product/strategy/business-context/business-info.md | Company context, product positioning | Medium |
| product-development/product/processes/launches/ | Recent launches the interviewee might reference | Low |
...
1. Search `product-development/product/customers/` for previous interview syntheses and findings
2. Identify validated themes from prior research
3. Note which PRDs or strategic initiatives these interviews relate to
4. Check `product-development/product/strategy/business-context/business-info.md` for product positioning context
...
- Found [N] previous interview syntheses in product-development/product/customers/
...
Save to product-development/product/customers/research-synthesis/[date]-interview-insights.md"
```
...
**Build a repository:**
- All past interviews in `product-development/product/customers/`
...
**Using Claude Code:**
- Keep all transcripts in `product-development/product/customers/accounts/{account}/calls/transcripts/`
...
| Check | Criteria | Pass? |
|-------|----------|-------|
| **Existing research referenced** | Cross-referenced with `product-development/product/customers/` findings | [ ] |
...
| **PRD linkage** | Insights connected to relevant active PRDs in `product-development/product/PRDs/{area}/` | [ ] |
