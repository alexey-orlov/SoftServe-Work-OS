...
- `{area}/reviews/` — Review artifacts for that area's PRDs: `[doc-name]-ralph-review.md` (`/ralph-wiggum`), `[prd-name]-review-synthesis.md` (`/prd-review-panel`), `[doc-slug]-red-team.md` (`/red-team`), `[feature-slug]-assumption-map.md` (`/assumption-map`), `[feature-slug]-premortem.md` (`/pre-mortem`)
