...
- 2026-08-13 — [Added the feature level between PRD and tickets](2026-08-13-feature-level-between-prd-and-tickets.md) — /feature-breakdown (the cut) + /feature-brief (the per-feature contract, challenge mode included); de-risk chain gains stage 5, index gains breakdown:/briefs: keys, two gated scaffolds (platform-model, tech-constraints) ground them
