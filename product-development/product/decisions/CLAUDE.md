...
- 2026-08-13 — [Made /prd-draft format-universal — the installed template owns document structure](2026-08-13-prd-draft-template-driven-format.md) — skill keeps method + evidence slots; house formats (first: Payworks Product Brief) land as the deployment's own prd-template.md, never in this repo; validated 13/13 by Opus format test
