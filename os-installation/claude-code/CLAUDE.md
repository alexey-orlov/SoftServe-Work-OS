...
- [scheduled-governance.md](scheduled-governance.md) — Enforcement once the repo is on GitHub: push ruleset for protected paths, the wiki-lint Action (PR check + weekly health issue), branch protection for admin-tier changes
