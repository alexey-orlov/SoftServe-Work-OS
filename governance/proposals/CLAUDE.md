...
**Read this when:** The session-start briefing says proposals are pending. Apply or reject
each one in an interactive session, then delete the proposal file.

## Contents

### Files

_Empty. Headless runs append entries here; humans clear them._
